...
export default function CreateNewsletter() {
  ...
  }, [watchTitle, watchSummary, watchCategory, tags, watchImage, content]);
  ...
  const handleConfirmRegenerate = async () => {
    ...
    try {
      ...
      const currentValue = 
        regeneratingField === 'title' ? watchTitle || '' :
        regeneratingField === 'summary' ? watchSummary || '' :
        regeneratingField === 'content' ? content || '' :
      ...
      if (regeneratingField === 'title') {
        ...
        // Tags might come as comma-separated string or array
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Write and publish a new newsletter</p>
        </div>
        <Button variant="outline" onClick={() => navigate('/admin/newsletters')}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-6">
          {/* Newsletter Idea Section */}
          <Card>
            <CardHeader>
              <CardTitle>Newsletter Idea</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="newsletterIdea">Enter your newsletter idea (optional)</Label>
                <Textarea
                  id="newsletterIdea"
                  rows={3}
                  placeholder="Describe your newsletter idea..."
                  value={newsletterIdea}
                  onChange={(e) => setNewsletterIdea(e.target.value)}
                />
              </div>
              <div>
                <Label htmlFor="newsletterAbout">What it's about (optional)</Label>
                <Textarea
                  id="newsletterAbout"
                  rows={3}
              ...
              <div className="flex justify-end">
                <Button
                  type="button"
                  onClick={handleGenerateFromNewsletterIdea}
                  disabled={isGenerating || (!newsletterIdea.trim() && !newsletterAbout.trim())}
                  className="gap-2"
                >
                  {isGenerating ? (
                    <>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  {watchSummary && watchSummary.trim() && (
                    <Button
                      type="button"
                      variant="ghost"
                      size="sm"
          ...
          {/* Action Buttons */}
          <div className="flex items-center justify-between">
            <Button type="button" variant="outline" onClick={() => navigate('/admin/newsletters')}>
              Cancel
            </Button>
            <div className="flex gap-2">
